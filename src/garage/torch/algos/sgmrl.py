"""SG-MRL algorithm implementation for RL."""
# yapf: disable
import collections
import copy
import pdb
...
class SGMRL:
    ...
    def _train_value_function(self, paths):
        ...
        """
        # SG-MRL resets a value function to its initial state before training.
    ...
    def _adapt(self, batch_samples, set_grad=True):
        """Performs one SG-MRL inner step to update the policy.
...
class _MAMLEpisodeBatch(
    ...
    r"""A tuple representing a batch of whole episodes in SG-MRL.
